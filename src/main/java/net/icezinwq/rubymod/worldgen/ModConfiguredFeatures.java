package net.icezinwq.rubymod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_DARK_RUBY_ORE_KEY = registerKey("dark_ruby_ore");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldDarkRubyOres = List.of(
                OreConfiguration.target(stoneReplaceables, ModBlocks.DARK_RUBY_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplaceables, ModBlocks.DEEPSLATE_DARK_RUBY_ORE.get().defaultBlockState()));

                register(context, OVERWORLD_RUBY_ORE_KEY, Feature.ORE, new OreConfiguration(overworldRubyOres, 5));
                register(context, OVERWORLD_DARK_RUBY_ORE_KEY, Feature.ORE, new OreConfiguration(overworldDarkRubyOres, 5));
