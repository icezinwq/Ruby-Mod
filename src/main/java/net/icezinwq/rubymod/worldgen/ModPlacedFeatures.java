...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> DARK_RUBY_ORE_PLACED_KEY = registerKey("dark_ruby_ore_placed");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, DARK_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_DARK_RUBY_ORE_KEY),
                ModOrePlacement.commonOrePlacement(4,
                        HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(16))));
    }
